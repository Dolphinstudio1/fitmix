...
class AudioApp extends StatefulWidget {
  ...
  AudioApp(String musicUrl){
    this.musicUrl = musicUrl;
  }
  @override
  _AudioAppState createState() => _AudioAppState(musicUrl);
}
...
class _AudioAppState extends State<AudioApp> {
  ...
  _AudioAppState(String musicUrl){
    this.musicUrl = musicUrl;
  }
  Duration duration;
  Duration position;
  ...
  Future play() async {
    await audioPlayer.play(musicUrl); //kUrl
    setState(() {
  ...
  Future _loadFile() async {
    final bytes = await _loadFileBytes(musicUrl,
